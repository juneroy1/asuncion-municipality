            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/">Home</a><i class="fa fa-angle-double-right"></i><span>VISION</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container card" style="background: #e8f9e9;padding: 40px; margin-bottom:30px;border-radius: 20px;">
                        ...
                        <p >We envision Asuncion as a peaceful Municipality where the people are God-fearing, Prosperous, Highly educated, Live long and Healthy lives, Resilient to Natural calamities and Man made shocks under a Trustworthy, Responsive, Efficient and People-centered governance.   </p>
                        {{-- <p></p> --}}
                        {{-- <div class="row">
                            <div class="col-md-6">
