...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Create Announcement</h3>
    ...
    <div class="container-fluid">
        ...
        @if ($department != 'super_admin')
            ...
            <form method="POST" action="/announcement" enctype="multipart/form-data" class="row">
                @csrf
            <!-- Column -->
                    ...
                    <div class="table-responsive">
                        <table class="table user-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><img width="200" height="200" src='../../images/{{$update->image}}'></td>
                                    <td>{{$update->title}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" style="color:white" onclick="approve({{$update->id}}, {{$idPage}})" href="#">Approve</a>
                                        {{-- @else --}}

                                        <a class="btn btn-danger" style="color:white" onclick="disapprove({{$update->id}}, {{$idPage}})" href="#">Disapprove</a>
                                        {{-- @endif --}}
                                        @else 
                                        <a class="btn btn-primary" style="color:white" href="/announcement-remarks/{{$update->id}}">Edit</a>
