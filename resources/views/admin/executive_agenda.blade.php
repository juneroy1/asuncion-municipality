@extends('layouts.master_admin', ['title' => 'executive_department', 'subtitle' => ''])
        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="page-title mb-0 p-0">{{ $edit ? 'Update Executive Agenda' : 'Create  Executive Agenda' }}</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $edit ? 'Update  Executive Agenda' : 'Create  Executive Agenda' }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            @if (\Session::has('error'))
                ...
                @if ($department != 'super_admin')
                    <form method="POST"
                        action="{{ $edit ? '/admin-manage-executive-file-update/' . $update->id : '/admin-manage-executive-file' }}"
                ...
                @if (!$edit)
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of Executive Agenda</h4>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a class="btn btn-primary"
                                                                href="/admin-manage-executive-file-edit/{{ $agenda->id }}"
    ...
    <script>
        function disapprove(id, idpage) {
            ...
            if (confirm_Final) {
                ...
                window.location.href = "/admin-remarks/" + id + "/" + idpage + "/ExecutiveAgendas"
            }
