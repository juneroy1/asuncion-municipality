                                    ...
                                    <tbody>
                                        ...
                                        <td style="{{$update->is_approved == 1 ? 'background:blue;color:white':($update->is_approved== 2? 'background:green;color:white': 'background:red;color:white')}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success" onclick="approve({{$update->id}},{{$idPage}})" style="color:white" href="#">Approve</a>
                                                ...
                                                @else 
                                                <a class="btn btn-success" style="color:white" href="/admin-edit/{{$update->id}}">Edit</a>
