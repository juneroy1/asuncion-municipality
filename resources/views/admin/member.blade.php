        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="page-title mb-0 p-0">{{ $edit ? 'Update Member' : 'Create Member' }}</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $edit ? 'Update Member' : 'Create Member' }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @if ($department != 'super_admin')
                    <form method="POST" action="{{ $edit ? '/update-member/' . $member->id : '/member' }}"
                        ...
                        <div class="col-lg-4 col-xlg-3 col-md-5">
                            <div class="card">
                                <div class="card-body profile-card">
                                    <center class="mt-4">
                                        <img src="{{ $member ? '/images/' . $member->image : '/foradmin/assets/images/users/5.jpg' }}"
                                ...
                                <div class="card-body">
                                    <div class="form-horizontal form-material mx-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="first_name" value="{{ $member ? $member->first_name : '' }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="educational_attainment"
                                                    value="{{ $member ? $member->educational_attainment : '' }}"
                                                    type="text" placeholder="Title of the update"
                                                    class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="course" type="text"
                                                    value="{{ $member ? $member->course : '' }}" placeholder="Course"
                                                    class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea name="others" rows="5"
                                                    class="form-control ps-0 form-control-line">{{ $member ? $member->others : '' }}"</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea name="remarks" rows="5"
                                                        class="form-control ps-0 form-control-line">{{ $member ? $member->remarks : '' }}"</textarea>
                                                </div>
                                            </div>
                                        @endif
                                        {{-- <div class="form-group">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($members as $update)
                                                <tr>
                                                    <td>
                                                        <div>
                                                            <img width="100" src="images/{{ $update->image }}" alt="">
                                                            <label for="">{{ $update->first_name }}
                                                                {{ $update->last_name }}</label>
                                                        </div>
                                                    </td>

                                                    <td>{{ $update->position }}</td>
                                                    <td>{{ $update->address }}</td>
                                                    <td>{{ $update->birthdate }}</td>
                                                    <td>{{ $update->religion }}</td>
                                                    <td>{{ $update->educational_attainment }}</td>
                                                    <td>{{ $update->course }}</td>
                                                    <td>{{ $update->others }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a class="btn btn-primary" style="color:white"
                                                                href="/edit-member/{{ $update->id }}">Edit</a>
                                                            {{-- @else --}}
