                                ...
                                <table class="table user-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                <img width="100" src="images/{{$mayor->image}}" alt="">
                                                <label for="">{{$mayor->first_name}} {{$mayor->last_name}}</label>    
                                            </div>
                                        </td>
                                            
                                            <td>{{$mayor->position}}</td>
                                            <td>{{$mayor->position}}</td>
                                            <td>{{$mayor->address}}</td>
                                            <td>{{$mayor->birthdate}}</td>
                                            <td>{{$mayor->religion}}</td>
                                            <td>{{$mayor->educational_attainment}}</td>
                                            <td>{{$mayor->course}}</td>
                                            <td>{{$mayor->others}}</td>
                                            <td>
                                                @if ($department == 'super_admin')
                                                @if ($mayor->is_approved == 0)
                                                <a style="color:blue" href="/approve-member/{{$mayor->id}}">Approve</a>
                                                @else
                                                <a style="color:red"  href="/remove-member/{{$mayor->id}}">Remove</a>
                                                @endif
                                                @endif
