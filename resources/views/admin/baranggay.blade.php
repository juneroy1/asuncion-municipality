        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="page-title mb-0 p-0">{{ $edit ? 'Update Barangay' : 'Create Barangay' }}</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $edit ? 'Update Barangay' : 'Create Barangay' }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @if ($department != 'super_admin')
                    <form method="POST" action="{{ $edit ? '/admin-barangay-update/' . $update->id : '/admin-barangay' }}"
                            ...
                            <div class="card">
                                <div class="card-body profile-card">
                                    <center class="mt-4">
                                        ...
                                        <img src="{{ $edit ? '/barangay/' . $update->image : '/foradmin/assets/images/users/5.jpg' }}"
                                            width="150" />
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a class="btn btn-primary"
                                                                href="/admin-barangay-edit/{{ $barangay->id }}"
