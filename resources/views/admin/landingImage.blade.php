            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Create Landing Image</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Create Landing Image</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="subtitle" rows="5" class="form-control ps-0 form-control-line"></textarea>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button type="submit" class="btn btn-success mx-auto mx-md-0 text-white">Submit Landing Image</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table user-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td><img width="200"  src='../../landing_images/{{$update->image}}'></td>
                                            <td>{{$update->title}}</td>
                                            ...
                                            <td style="{{$update->is_approved == 1 ? 'background:blue;color:white':($update->is_approved== 2? 'background:green;color:white': 'background:red;color:white')}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary" style="color:white" onclick="approve({{$update->id}},{{$idPage}})">Approve</a>
                                               
                                                <a class="btn btn-danger" style="color:white" onclick="disapprove({{$update->id}},{{$idPage}})">Disapprove</a>
                                                {{-- @endif --}}
                                                 @else
