        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                {{-- @if ($department != 'super_admin') --}}
                    <form method="POST" action="/department-update/{{$admint_department->id}}" enctype="multipart/form-data" class="row">
                        @csrf
                        <!-- Column -->
                        <div class="col-lg-4 col-xlg-3 col-md-5">
                            <div class="card">
                                <div class="card-body profile-card">
                                    <center class="mt-4">
                                        <img src="{{$admint_department->image? '/departments/'.$admint_department->image:'/foradmin/assets/images/users/5.jpg'}}" class="rounded-circle" width="150" />
                                ...
                                <div class="card-body">
                                    <div class="form-horizontal form-material mx-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="name" value="{{$admint_department->name}}" type="text" placeholder="Title of the update"
                                                    class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="d_head_name" value="{{$admint_department->d_head_name}}" type="text" placeholder="Title of the update"
                                                    class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="description" value="{{$admint_department->description}}"  type="text" placeholder="Title of the update"
                                                    class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select name="type_office" class="form-select"
                                                    ...
                                                    <option selected="{{$admint_department->type_office == 1? true:false}}" value="1" selected>Executive</option>
                                                    <option selected="{{$admint_department->type_office == 2? true:false}}" value="2">Legislative</option>
                                                </select>
                                            </div>
                                        </div>
