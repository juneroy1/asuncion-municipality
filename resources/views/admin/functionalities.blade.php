                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea name="description" rows="5"
                                                    class="form-control ps-0 form-control-line">{{ $edit ? $update->description : '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($functionalities as $functionality)
                                                <tr>
                                                    ...
                                                    <td
                                                        style="{{ $functionality->is_approved == 1? 'background:blue;color:white': ($functionality->is_approved == 2? 'background:green;color:white': 'background:red;color:white') }}">
                                                    ...
                                                    <td>
                                                        @if ($department == 'super_admin')
                                                            ...
                                                            <a class="btn btn-primary"
                                                                onclick="approve({{ $functionality->id }},{{ $idPage }})"
                                                                style="color:white">Approve</a>
                                                            <a class="btn btn-danger"
                                                                onclick="disapprove({{ $functionality->id }},{{ $idPage }})"
                                                                style="color:white">Disapprove</a>
                                                        @else
                                                            <a class="btn btn-primary"
                                                                href="/admin-functionalities-edit/{{ $functionality->id }}"
