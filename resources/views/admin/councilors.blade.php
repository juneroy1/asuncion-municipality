        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Create New Mayor</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Create New Mayor</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">List of Mayor</h4>
                                ...
                                <table class="table user-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                <img width="100" src="images/{{$councilor->image}}" alt="">
                                                <label for="">{{$councilor->first_name}} {{$councilor->last_name}}</label>    
                                            </div>
                                        </td>
                                            
                                            <td>{{$councilor->position}}</td>
                                            <td>{{$councilor->position}}</td>
                                            <td>{{$councilor->address}}</td>
                                            <td>{{$councilor->birthdate}}</td>
                                            <td>{{$councilor->religion}}</td>
                                            <td>{{$councilor->educational_attainment}}</td>
                                            <td>{{$councilor->course}}</td>
                                            <td>{{$councilor->others}}</td>
                                            <td>
                                                @if ($department == 'super_admin')
                                                @if ($councilor->is_approved == 0)
                                                <a style="color:blue" href="/approve-member/{{$councilor->id}}">Approve</a>
                                                @else
                                                <a style="color:red"  href="/remove-member/{{$councilor->id}}">Remove</a>
                                                @endif
                                                @endif
