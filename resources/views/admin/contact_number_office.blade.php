        ...
        <div class="page-breadcrumb">
            <div class="row align-items-center">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="page-title mb-0 p-0">Create Contact Number</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Create Contact Number</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @if ($department != 'super_admin')
                    ...
                    <form method="POST" action="/contact-number-office-create" enctype="multipart/form-data"
                        class="row">
                        @csrf
                        <!-- Column -->
                                ...
                                <div class="card-body">
                                    <div class="form-horizontal form-material mx-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="name" class="form-control ps-0 form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
