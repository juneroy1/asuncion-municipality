        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div style="background-image: url('/images/officials/group/ldrrmo/IMG_0819.JPG') !important" id="header" class="headerMayorOffice">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="text-container">
                                        ...
                                        <p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <h1>DR. EDGAR T. CASTILLO, RN, DPA</h1>
                                        <h2 style="color:white">And Office Personnel</h2>
                                        <h2 style="color:white">LDRRMO & OIC-MENRO</h2>
              ...
              <div class="carousel-item">
                <div style="background-image: url('/images/officials/group/ldrrmo/IMG_1041.JPG') !important"  id="header" class="headerMayorOffice2">
                    <div class="header-content">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
