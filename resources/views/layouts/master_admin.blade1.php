...
<html dir="ltr" lang="en">
    ...
    <head>
        ...
        <link href="/foradmin/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="/foradmin/assets/images/users/1.jpg" alt="user" class="profile-pic me-2">{{Auth::user()->name}}
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <form action="/logout" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-success mx-auto mx-md-0 text-white">Logout</button>
                                </form>
                                {{-- <form class="app-search" style="display: none;">
                                    <input type="text" class="form-control" placeholder="Search &amp; enter"> <a
                                        class="srh-btn"><i class="ti-close"></i></a> </form> --}}
                        ...
                        <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="index.html" aria-expanded="false"><i class="mdi me-2 mdi-gauge"></i><span
                                    ...
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                        ...
                                        <i class="mdi me-2 mdi-account-check"></i><span class="hide-menu">Upload Update</span></a>
                                </li>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-functionalities" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Office Mandate</span></a></li>    
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-officials" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Officials</span></a></li> 
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-officials-archive" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Archive for officials</span></a></li> 
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-department-archive" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Archive for department</span></a></li> 
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-barangay-officials" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Barangay Officials</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/admin-barangay" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Barangay</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/contact-number-office" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">Office Contact Number</span></a></li>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="/department-list" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                        class="hide-menu">List of Department</span></a></li>
                                {{-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
