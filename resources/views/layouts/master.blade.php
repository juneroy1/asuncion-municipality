...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <a style="display:contents" class="navbar-brand logo-image" href="/">
            {{-- --}}
            {{-- <img style="display: inline" src="/images/logo/cambanogoy.JPG" width="100" height="500"
                alt="alternative"> --}}
            <div style='width: 100px; height: 100px;' class="test"></div>
            {{-- <img class="avatar" style="display: inline" src="/images/Municipal Logo.png" width="100" height="500"
                alt="alternative"> --}}
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    @if($title=='officials')
                    <a class="nav-link dropdown-toggle page-scroll" href="#header" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">OFFICIALS<span class="sr-only">(current)</span></a>
                    @else
                    <a class="nav-link dropdown-toggle page-scroll" href="#" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">OFFICIALS</a>
                    @endif
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @else
                        <a class="dropdown-item" href="/officials-view"><span class="item-text">MUNICIPAL
                                OFFICIALS</span></a>
                        @endif
                        ...
                        @else
                        <a class="dropdown-item" href="/legislative"><span class="item-text">LEGISLATIVE
                                BRANCH</span></a>
                        @endif
                ...
                {{-- <li class="nav-item">
                    @if($title=='officials')
                    <a class="nav-link page-scroll" href="#header">MUNICIPAL OFFICIALS<span
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link page-scroll" href="#header">LEGISLATIVE BRANCH<span
                            class="sr-only">(current)</span></a>
                    @else
                ...
                {{-- <li class="nav-item dropdown">
                    ...
                    <a class="nav-link page-scroll" href="#header">NATIONAL OFFICE <span
                            class="sr-only">(current)</span></a>
                    @else
                    ...
                    <a class="nav-link dropdown-toggle page-scroll" href="#header" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">DEPARTMENTS<span class="sr-only">(current)</span></a>
                    @else
                    <a class="nav-link dropdown-toggle page-scroll" href="#" id="navbarDropdown" role="button"
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle page-scroll" href="#header" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">DEPARTMENTS<span class="sr-only">(current)</span></a>
                    @else
                    <a class="nav-link dropdown-toggle page-scroll" href="/see-all-offices" id="navbarDropdown"
                        role="button" aria-haspopup="true" aria-expanded="false">DEPARTMENTS</a>
                    @endif
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @else
                        <a class="dropdown-item" href="/see-all-offices"><span class="item-text">EXECUTIVE
                                BRANCH</span></a>
                        @endif
                        ...
                        <a class="dropdown-item" href="#header"><span class="item-text">LEGISLATIVE BRANCH</span></a>
                        @else
                        <a class="dropdown-item" href="/see-all-offices-legislative"><span class="item-text">LEGISLATIVE
                                BRANCH</span></a>
                        @endif
                ...
                <li class="nav-item dropdown">
                    @if($title=='projects')
                    <a class="nav-link dropdown-toggle page-scroll" href="#header" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">PROGRAMS AND SERVICES <span
                            class="sr-only">(current)</span></a>
                    @else
                    <a class="nav-link dropdown-toggle page-scroll" href="/see-all-projects" id="navbarDropdown"
                        role="button" aria-haspopup="true" aria-expanded="false">PROGRAMS AND SERVICES </a>
                    @endif
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @else
                        <a class="dropdown-item" href="/see-all-projects/help"><span
                                class="item-text">H-HEALTH</span></a>
                        @endif

                        @if($subtitle=='education' && $title=='projects')
                        <a class="dropdown-item" href="#header"><span class="item-text">E-EDUCATION</span></a>
                        @else
                        <a class="dropdown-item" href="/see-all-projects/education"><span
                                class="item-text">E-EDUCATION</span></a>
                        @endif

                        @if($subtitle=='livelyhood' && $title=='projects')
                        <a class="dropdown-item" href="#header"><span class="item-text">L-LIVELIHOOD</span></a>
                        @else
                        <a class="dropdown-item" href="/see-all-projects/livelihood"><span
                                class="item-text">L-LIVELIHOOD</span></a>
                        @endif

                        @if($subtitle=='projects' && $title=='projects')
                        <a class="dropdown-item" href="#header"><span class="item-text">P-PROJECTS</span></a>
                        @else
                        <a class="dropdown-item" href="/see-all-projects/projects"><span
                                class="item-text">P-PROJECTS</span></a>
                        @endif
                ...
                {{-- <li class="nav-item dropdown">
                    @if($title=='projects')
                    <a class="nav-link page-scroll" href="#header">PROGRAMS AND SERVICES<span
                            class="sr-only">(current)</span></a>
                    @else
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown" role="button"
                        aria-haspopup="true" aria-expanded="false">ABOUT LGU</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="/pdf/LCE AGENDA 2019-2025.pdf" target="_blank"
                            rel="noopener noreferrer"><span class="item-text">EXECUTIVE AND LEGISLATIVE
                                AGENDA</span></a>
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="/historical"><span class="item-text">HISTORICAL
                                BACKGROUND</span></a>
                    </div>
                </li>
                <li class="nav-item dropdown">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">© The Official Website of Municipality Government of Asuncion. All Right Reserved
                        2022</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
