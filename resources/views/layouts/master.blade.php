        ...
        <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
            ...
            <!-- Image Logo -->
                <a style="display:contents" class="navbar-brand logo-image" href="/">
                    ...
                    {{-- <img class="avatar" style="display: inline" src="/images/Municipal Logo.png" width="100" height="500" alt="alternative"> --}}re
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            @if($subtitle=='health' && $title=='projects')
                                <a class="dropdown-item" href="#header"><span class="item-text">H-HEALTH</span></a>
                            @else 
                                <a class="dropdown-item" href="/see-all-projects/health"><span class="item-text">H-HEALTH</span></a>
                            @endif
                    ...
                    <!-- Dropdown Menu -->          
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">ABOUT THE LGU</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
...
{{--     
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="p-small">© Official Website of the Municipality of Asuncion. All Rights Reserved 2024</a></p>
                    </div> <!-- end of col -->
                </div> <!-- enf of row -->
