    ...
    <div class="row">
        <div class="col-md-6">
            <div style="margin: 50px; padding-bottom: 0px !important; margin-bottom: 0px" class="filter">
                <div class="card" style="background: #e8f9e9;padding: 5px; margin-bottom:30px;border-radius: 20px;">
                    <div style="cursor: pointer; margin: 10px; padding:10px;padding-bottom: 20px;"
                        class="container-fluid m-10">
                        <div class="row">
                            <div class="col-lg-12">
                                <a style="text-decoration: none" href="/vision" target="_blank"
                                    rel="noopener noreferrer">
                                    <h3 style="text-align: center">OUR VISION</h3>
                                    <!-- style="text-transform: uppercase" -->
                                    <p style="color: black;">We envision Asuncion as a peaceful municipality where the
                                        people are God-fearing, prosperous, highly educated, live long and with healthy
                                        lives, resilient to natural...</p>
                    ...
                    <div style="cursor: pointer; margin: 10px;padding:10px;padding-top: 0px;" class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <a href="/mission" style="text-decoration: none" target="_blank"
                                    rel="noopener noreferrer">
                                    <h3 style="text-align: center;color: black;">OUR MISSION</h3>
                                    <!--<h5>&nsbp;</h5>-->
                                    <br />
                                    <p style="color: black;">Institute a God-centered and morally upright local
                                        government unit that is:</p>
        ...
        <div class="col-md-6">
            <div class="container p-3 m-4">
                ...
                <div style="margin: 50px; padding-bottom: 0px !important; margin-bottom: 0px;margin-top: 10px;"
                    class="filter">
                    <div class="card"
                        style="background: #e8f9e9;padding: 40px; margin-bottom:30px;border-radius: 20px;">
                                    ...
                                    <ul style="list-style-type:none; padding: 0;">
                                        ...
                                        <li class="table-style">
                                            <div style="display: flex;
                                                    ...
                                                    margin-bottom: 20px;
                                                    padding-bottom: 10px;">
                                                <div style="width: 150px;font-size: 20px;color: black; ">{{
                                                    $emergencyHotline->name }}</div>
                                                <div style="width:400px;font-size: 20px;color: black;"><b>{{
                                                        $emergencyHotline->number }} ({{ $emergencyHotline->network
                                                        }})</b></div>
                                            </div>
                                        </li>
                                        @endforeach
            ...
            <div class="col-lg-12">
                ...
                <section>
                    <div class="content" style="margin-left: 30vw;">
                        <h2
                            style="color: #d7d550;font-family: &quot;Poppins&quot;, sans-serif !important;font-weight: 900!important;font: 699 10.75rem/8.125rem &quot;Montserrat&quot;, sans-serif;">
                            WOW</h2>
                        <h2
                            style="font-family: &quot;Poppins&quot;, sans-serif !important;font-weight: 900!important;font: 699 10.75rem/8.125rem &quot;Montserrat&quot;, sans-serif;">
                            WOW</h2>
                ...
                {{-- <div id="headingOne">
                    <span data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                        ...
                        <span class="circle-numbering">1</span><span
                            class="accordion-title">{{$latest->description}}</span>
                    </span>
                </div>
            ...
            <div class="tab-content" id="ariaTabsContent">
                ...
                <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                    <p><strong>We strive to achieve</strong> 100% customer satisfaction for both types of
                        customers: hiring companies and job seekers. Types of customers: <a class="green"
                                ...
                                <a style="margin-left: 50px; text-decoration: none;
                                    ...
                                    <div class="card-body">
                                        {{-- <div class="testimonial-text">My goals for using Aria's services seemed
                                            high when I first set them but they've met them with no problems.</div> --}}
                                    ...
                                    <div class="card-test">
                                        <a style="margin-left: 50px; text-decoration: none;
                                            ...
                                            <img class="card-image"
                                                ...
                                                alt="alternative">
                                            <div class="card-body">
                                                {{-- <div class="testimonial-text">The guys from Aria helped with
                                                    getting my business off the ground and turning into a profitable
                                                    company.</div> --}}
