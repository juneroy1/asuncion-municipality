...
Route::post('/admin-manage-legislative-file', 'LegislativeBranchFileController@storeDepartment')->name('department-archive_create');
...
Route::post('/remove-legislative-file/{id}/{idPage}', 'LegislativeBranchFileController@removeDepartment')->name('remove-department-archive');
...
Route::get('/update-view/{id}', 'LandingImageController@viewUpdateImage')->name('view.landingImage');
